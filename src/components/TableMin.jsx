...
import { COLUMNS, COLUMNS_MID_SCREENS } from "./table/Columns";
...
const TableMin = ({ data }) => {
  ...
  const columns = useMemo(() => COLUMNS_MID_SCREENS, []);
      ...
      <div>
        <div>
                  ...
                  >
                    {row.cells.map((cell) => {
                      return (
                        <td
                          {...cell.getCellProps()}
                          className="whitespace-nowrap px-1 py-2 font-medium dark:text-white"
                        >
                          {cell.render("Cell")}
                        </td>
                      );
          ...
          <div className="flex justify-between">
            ...
            <select
              className="bg-secondary-dark-bg text-white rounded-md"
              value={pageSize}
