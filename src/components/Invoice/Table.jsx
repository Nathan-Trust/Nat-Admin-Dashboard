...
export default function Table({ list, setList, total, bankAccount, bankName }) {
  return (
    <>
      <table style={{ width: "100%" }} className="my-10 ">
        <thead className="">
          <tr>
      ...
      <div className="flex ml-[180px] flex-col print-total">
        <div
      ...
      <p className="text-[9px] ml-24 mt-2 print-note">
        to the business account below. Please include invoice number on your
        check
      </p>
      <div className="flex ml-[200px] gap-3 mt-1 mb-2 print-bank ">
